            ...
            <div class="col-6 pb-1">
                <div class="text-muted" id="create-ticket-<?php echo $chat->id ?>"
                    ...
                    <span class="material-icons action-image"
                        onclick='lhc.revealModal({"iframe" : true, "title" : <?php echo json_encode(htmlspecialchars_decode(erTranslationClassLhTranslation::getInstance()->getTranslation('chat/adminchat', 'Criar Chamado')), JSON_HEX_QUOT) ?>, height: "600", "url":WWW_DIR_JAVASCRIPT+"chat/ticketg3stor"})'
